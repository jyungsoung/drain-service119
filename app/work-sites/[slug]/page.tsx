...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title: work.title, description: work.summary, url: `/work-sites/${work.slug}`, type: "article", publishedTime: work.date, modifiedTime: work.updatedAt || work.date, images: [{ url: work.image, alt: work.imageAlt || work.title }] },
  };
}
