...
export const metadata: Metadata = {
  ...
  openGraph: { title: "경기도 배관막힘 지역 안내 | 응급배관119", description: "경기도 시·군·구·동별 배관막힘 지역 페이지", images: ["/images/service-dispatch.webp"], type: "website", locale: "ko_KR" },
};

export default function GyeonggiIndex() {
  const itemList = { "@context":"https://schema.org", "@type":"ItemList", name:"경기도 배관 서비스 지역", itemListElement:cities.map((city,index)=>({"@type":"ListItem",position:index+1,name:city.name,url:`https://drain-service119.netlify.app/gyeonggi/${city.slug}`})) };
  return <main className="regionPage">
    <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(itemList)}} />
    <header className="topbar"><a className="brand" href="/"><img className="brandSeal" src="/images/emergency-pipe-stamp.jpeg" alt="응급배관 도장 로고" /><span className="brandText"><span className="brandName">응급배관</span><span className="brandNumber">119</span></span></a><nav><a href="/services">배관 서비스</a><a href="#cities">시·군 선택</a><a href="/service-area">서울·인천·강원·충청</a><a href="/">홈</a></nav><a className="headerCall" href="tel:16681321">1668-1321</a></header>
