...
export const metadata: Metadata = {
  title: "경기도 싱크대막힘·변기막힘·하수구막힘 지역 안내 | 우리동네전문가",
  description: "경기도 31개 시·군, 일반구와 600개 읍면동의 싱크대막힘·변기막힘·하수구막힘·고압세척 상담 지역 안내.",
  alternates: { canonical: "/gyeonggi" },
  openGraph: { title: "경기도 배관막힘 지역 안내 | 우리동네전문가", description: "경기도 시·군·구·동별 배관막힘 지역 페이지", images: ["/images/service-dispatch.webp"], type: "website", locale: "ko_KR" },
};

export default function GyeonggiIndex() {
  const itemList = { "@context":"https://schema.org", "@type":"ItemList", name:"경기도 배관 서비스 지역", itemListElement:cities.map((city,index)=>({"@type":"ListItem",position:index+1,name:city.name,url:`https://service.drain119.co.kr/gyeonggi/${city.slug}`})) };
  return <main className="regionPage">
    <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(itemList)}} />
    <header className="topbar"><a className="brand" href="/"><span className="brandText"><span className="brandName">우리동네</span><span className="brandNumber">전문가</span></span></a><nav><a href="/services">배관 서비스</a><a href="#cities">시·군 선택</a><a href="/service-area">서울·인천·강원·충청</a><a href="/">홈</a></nav><a className="headerCall" href="tel:16681321">1668-1321</a></header>
    <section className="regionIndexHero"><p className="kicker">GYEONGGI SERVICE AREA</p><h1>경기도 배관 서비스 지역 안내,<br /><em>시·군·구·동별 생활권 정보</em></h1><p>경기도 31개 시·군과 일반구, 600개 읍·면·동을 연결했습니다. 현재 위치를 선택하면 지역별 배관막힘 증상과 상담 내용을 확인할 수 있습니다.</p><a className="primary" href="tel:16681321">경기도 배관 상담 1668-1321</a></section>
